 ...
 * 流程定义表
 */
public class FlowProcess extends MyBaseEntity {
   ...
   * 流程版本 FLOW_VERSION
   */
  private java.lang.Long flowVersion;
  ...
  public java.lang.Long getFlowVersion() {
    return flowVersion;
  }

  public void setFlowVersion(java.lang.Long flowVersion) {
  ...
  public String toString() {
   ...
   // sb.append(",state=").append(this.getStatus());
    sb.append(")");
    return sb.toString();
  }
}