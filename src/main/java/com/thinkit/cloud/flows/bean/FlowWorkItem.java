 ...
 * 工作项（待办、已处理任务的查询结果实体）
 */
public class FlowWorkItem extends MyBaseEntity {
  /**
   * 
   */
  ...
  public Map<String, Object> getOrderVariableMap() {
    Map<String, Object> map = JsonUtil.fromJson(this.orderVariable, Map.class);
    if (map == null)  {
  ...
  public Map<String, Object> getTaskVariableMap() {
    Map<String, Object> map = JsonUtil.fromJson(this.taskVariable, Map.class);
    if (map == null)  {
      return Collections.emptyMap();
    }
    return map;
