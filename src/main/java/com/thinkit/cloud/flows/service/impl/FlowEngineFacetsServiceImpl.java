...
public class FlowEngineFacetsServiceImpl implements FlowEngineFacetsService, Serializable {
  ...
  public FlowOrder startAndExecute(String name, Long version, String operator, Map<String, Object> args)
    ...
    List<FlowTask> tasks = getEngine().flowQueryService().getActiveTasks(String.valueOf(order.getId()));
  ...
  public List<FlowTask> transferMajor(String taskId, String operator, String... actors) throws Exception {
    List<FlowTask> tasks = getEngine().flowTaskServiceApi().createNewTask(taskId, String.valueOf(TaskType.Major.ordinal()), actors);
  ...
  public List<FlowTask> transferAidant(String taskId, String operator, String... actors) throws Exception {
    List<FlowTask> tasks = getEngine().flowTaskServiceApi().createNewTask(taskId, String.valueOf(TaskType.Aidant.ordinal()), actors);
    getEngine().flowTaskServiceApi().complete(taskId, operator);
    return tasks;
  }
