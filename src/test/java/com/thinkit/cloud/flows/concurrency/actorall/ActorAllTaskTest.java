package com.thinkit.cloud.flows.concurrency.actorall;
...
public class ActorAllTaskTest extends FlowBaseTest {
  ...
  public void before() {
    processId = flowEngine.flowProcessService()
        .deploy(FileUtil.getStreamFromClasspath("com/lj/app/core/common/flows/concurrency/actorall/flow1.xml"));
  }
