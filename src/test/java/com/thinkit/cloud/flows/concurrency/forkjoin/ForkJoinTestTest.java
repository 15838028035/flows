package com.thinkit.cloud.flows.concurrency.forkjoin;
...
public class ForkJoinTestTest extends FlowBaseTest {
  ...
  public void before() {
    processId = flowEngine.flowProcessService()
        .deploy(FileUtil.getStreamFromClasspath("com/lj/app/core/common/flows/concurrency/forkjoin/flow1.xml"));
  }
